...
if TRAINING_STAGE == 1:
        ...
        resume_path = './checkpoints/lightning_logs/version_1/checkpoints/epoch=19-step=2180.ckpt'  # 使用阶段1训练得到的模型进行阶段2训练
###修改1结束############################################
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(accelerator='cuda', precision=32, max_epochs=50, num_nodes=NUM_NODES, accumulate_grad_batches=grad_accum, callbacks=[logger, checkpoint_callback], default_root_dir=root_dir, enable_progress_bar=True,devices=1)
    # Train!
